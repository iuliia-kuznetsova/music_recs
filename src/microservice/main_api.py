...
recs_offline_service_port = os.getenv('RECS_OFFLINE_SERVICE_PORT')
events_service_port = os.getenv('EVENTS_SERVICE_PORT')
features_service_port = os.getenv('FEATURES_SERVICE_PORT')
